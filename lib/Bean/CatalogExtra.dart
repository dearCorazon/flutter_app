...
class CatalogExtra{
  ...
  int status3;
  int status4;
  CatalogExtra.create(this.catalogId,this.number,this.status1,this.status2,this.status3,this.status4,this.name);
  ...
  CatalogExtra.fromMap(Map<String ,dynamic> map){
